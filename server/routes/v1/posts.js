...
// post comment
router.post("/posts/:post_id/comments", middleware.apiAuth, post.comments.create);
router.put("/posts/:post_id/comments/:comment_id", middleware.apiAuth, post.comments.update);
router.delete("/posts/:post_id/comments/:comment_id", middleware.apiAuth, post.comments.destroy);
