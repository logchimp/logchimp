...
const config = () => {
	...
	const databasePort = process.env.LOGCHIMP_DATABASE_PORT;
	const databaseName = process.env.LOGCHIMP_DATABASE_NAME;
	const databaseSsl = process.env.LOGCHIMP_DATABASE_SSL;
	...
	logger.info("LogChimp configuraiton missing");
};
