declare namespace NodeJS {
  interface ProcessEnv {
    ...
    readonly LOGCHIMP_BLACKLISTED_DOMAINS: string | undefined;

    // License
    readonly LOGCHIMP_LICENSE_KEY: string | undefined;
    readonly LOGCHIMP_SIGNATURE_TOKEN: string | undefined;
